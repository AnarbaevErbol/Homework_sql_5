...
select *
from cars
where color = 'Red' or color = 'Blue';--4
...
select *
from cars
where model like 'T%';--9

select *
from cars
where model like '%e';--10

select *
from cars
where length(brand)=5; --11

select sum(price) as sum_of_Mers
from cars
where brand='Mercedes-Benz';--12

select *
from cars
where price =(select max(price)from cars)
   or price=(select min(price)from cars);--13

select *
from cars
where brand not in('Toyota');--14
...
offset 5 limit 10;--16

select *
from cars
where year_of_issue not between 1995 and 2005;--17
